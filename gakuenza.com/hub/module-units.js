...
(function () {
  ...
  window.MODULE_UNITS = {
    ...
    // (window.SANSU2_DATA.UNITS), documented in modules/sansu2/README.md. The
    // module runner reads focus_units and foregrounds these same keys on its
    // menu. かけ算九九 spans units 11–12. (No 2年のまとめ review unit exists in
    // this build, so there is nothing to exclude — every unit is a real
    // focus-unit target.)
    sansu2: [
    ...
    // u13_review (6年のまとめ／算数のしあげ) is intentionally excluded — a
    // mixed review, not a focus-unit target.
    sansu6: [
