// kanken3-report.js — reports a completed 漢検3級 practice set via the shared
...
(function () {
  ...
  async function reportKanken3(sb, ctx, { categoryKey, categoryLabel, results }) {
    ...
    const activityRef = `kanken3/${categoryKey}/${Date.now()}`;
  ...
  window.Kanken3Report = { reportKanken3 };
})();
