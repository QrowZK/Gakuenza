// kanken4-report.js — reports a completed 漢検4級 practice set via the shared
...
(function () {
  ...
  async function reportKanken4(sb, ctx, { categoryKey, categoryLabel, results }) {
    ...
    const activityRef = `kanken4/${categoryKey}/${Date.now()}`;
  ...
  window.Kanken4Report = { reportKanken4 };
})();
